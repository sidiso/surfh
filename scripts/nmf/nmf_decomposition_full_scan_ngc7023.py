...
np.save(template_dir + f'NMF/full_scan_{mrs_lim_band[0]}_to_{mrs_lim_band[1]}_{components.shape[0]}_nmf_components_and_{thin_components.shape[0]-components.shape[0]}_spectral_lines.npy', thin_components)
