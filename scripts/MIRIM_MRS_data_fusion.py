...
def parse_options(fusion_dir, npix, hyper_parameter, niter, n_templates, scale_data, method, filtered_data, verbose):
    ...
    list_filter = ['F560W', 'F770W', 'F1000W', 'F1130W', 'F1280W', 'F1500W', 'F1800W', 'F2100W']
    imshape = (npix, npix)
    ...
    np.save('/home/nmonnier/Data/JWST/NGC_7023/Fusion/Templates/H_freq.npy', MIRIModel.H_freq)
