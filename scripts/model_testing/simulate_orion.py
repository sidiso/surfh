...
wave = np.arange(n_wavelenght)*wave_step + 4.68044
...
spectro = spectro.Spectro(
    [miri.ch1b],#, miri.ch1b, miri.ch1c, miri.ch2a],#, miri.ch2b, miri.ch2c],#, miri.ch3a, miri.ch3b, miri.ch3c, miri.ch4a, miri.ch4b, miri.ch4c],
    alpha_axis,
    beta_axis,
    wavel_axis,
    sotf,
...
# slits = spectro.get_slits_data()

# start = time.time() 

# cubeT = spectro.adjoint(data)
# ncube = spectro.sliceToCube(data)#     spectro.adjoint(data)
# end = time.time()
